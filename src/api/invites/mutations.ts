...
export const useCreateHouseholdAndInvite = () => {
  return useMutation({
    mutationFn: async (): Promise<HouseholdInviteResult> => {
...
export const useGetOrCreateHouseholdInvite = () => {
  return useMutation({
    mutationFn: async ({ householdId, profileId }: { householdId: string; profileId: string }): Promise<HouseholdInviteResult> => {
...
export const useAcceptHouseholdInvite = () => {
  return useMutation({
    mutationFn: async (inviteCode: string): Promise<AcceptInviteResult> => {
...
export const useSendEmailInvite = () => {
  return useMutation({
    mutationFn: async (params: { inviteCode: string; email: string; senderName: string }) => {
