    ...
    <SonnerToaster
      ...
      toastOptions={{
        ...
        classNames: {
          ...
          actionButton: 'bg-primary text-background-dark px-4 py-2 rounded-xl text-[12px] font-bold hover:brightness-110 active:scale-95 transition-all whitespace-nowrap shrink-0',
          cancelButton: 'bg-surface-2/10 text-toast-text/60 px-4 py-2 rounded-xl text-[12px] font-bold hover:bg-surface-2/20 hover:text-toast-text transition-all whitespace-nowrap shrink-0',
