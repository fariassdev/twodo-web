...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-20 bg-background-dark/90 backdrop-blur-xl border-t border-primary/10 pb-3 pt-2 px-6">
      <div className="max-w-md mx-auto flex justify-between items-center">
        ...
        <div className="relative -top-4">
          <Link to="/create" className="h-12 w-12 rounded-full bg-primary text-background-dark shadow-lg shadow-primary/40 flex items-center justify-center hover:scale-105 active:scale-95 transition-transform">
